...
public class Materia implements Serializable {
    ...
    @Min(value = 1, message = "El cuatrimestre debe ser al menos 1")
    @Max(value = 2, message = "El cuatrimestre no puede ser mayor que 2")
    private Integer cuatrimestre;  // Cuatrimestre (1 o 2)
